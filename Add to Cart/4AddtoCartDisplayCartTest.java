...
import java.net.URL;
public class 4AddtoCartDisplayCartTest {
  ...
  @Test
  public void 4AddtoCartDisplayCart() {
    // Test name: 4_Add to Cart_Display Cart
    ...
    // 13 | click | css=*[data-test="shopping-cart-link"] | 
    driver.findElement(By.cssSelector("*[data-test=\"shopping-cart-link\"]")).click();
    // 14 | assertText | css=*[data-test="title"] | Your Cart
    assertThat(driver.findElement(By.cssSelector("*[data-test=\"title\"]")).getText(), is("Your Cart"));
    // 15 | verifyText | css=*[data-test="checkout"] | Checkout
    assertThat(driver.findElement(By.cssSelector("*[data-test=\"checkout\"]")).getText(), is("Checkout"));
    // 16 | close |  | 
    driver.close();
  }
}
