...
describe('TC3_Error handling', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('TC3_Error handling', async function() {
    // Test name: TC3_Error handling
    ...
    // 17 | assertElementPresent | css=*[data-test="continue"] | 
    {
      const elements = await driver.findElements(By.css("*[data-test=\"continue\"]"))
      assert(elements.length)
    }
    // 18 | assertElementPresent | css=*[data-test="firstName"] | 
    {
      const elements = await driver.findElements(By.css("*[data-test=\"firstName\"]"))
      assert(elements.length)
    }
    // 19 | click | css=*[data-test="continue"] | 
    await driver.findElement(By.css("*[data-test=\"continue\"]")).click()
    // 20 | assertText | css=*[data-test="error"] | Error: First Name is required
    assert(await driver.findElement(By.css("*[data-test=\"error\"]")).getText() == "Error: First Name is required")
    ...
    // 23 | click | css=*[data-test="continue"] | 
    await driver.findElement(By.css("*[data-test=\"continue\"]")).click()
    // 24 | assertText | css=*[data-test="error"] | Error: Last Name is required
    assert(await driver.findElement(By.css("*[data-test=\"error\"]")).getText() == "Error: Last Name is required")
    // 25 | click | css=*[data-test="lastName"] | 
    await driver.findElement(By.css("*[data-test=\"lastName\"]")).click()
    // 26 | type | css=*[data-test="lastName"] | Handoko
    await driver.findElement(By.css("*[data-test=\"lastName\"]")).sendKeys("Handoko")
    // 27 | click | css=*[data-test="continue"] | 
    await driver.findElement(By.css("*[data-test=\"continue\"]")).click()
    // 28 | assertText | css=*[data-test="error"] | Error: Postal Code is required
    assert(await driver.findElement(By.css("*[data-test=\"error\"]")).getText() == "Error: Postal Code is required")
    // 29 | click | css=*[data-test="postalCode"] | 
    await driver.findElement(By.css("*[data-test=\"postalCode\"]")).click()
    // 30 | type | css=*[data-test="postalCode"] | 51 Jefferson Ave Unit #201, Toronto, ON M6K1Y3,Canada
    await driver.findElement(By.css("*[data-test=\"postalCode\"]")).sendKeys("51 Jefferson Ave Unit #201, Toronto, ON M6K1Y3,Canada")
    // 31 | click | css=*[data-test="continue"] | 
    await driver.findElement(By.css("*[data-test=\"continue\"]")).click()
    // 32 | assertText | css=*[data-test="title"] | Checkout: Overview
